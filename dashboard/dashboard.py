...
if not filtered_day.empty:
    ...
    st.plotly_chart(fig,use_container_width=True, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
...
with colA:
    if not filtered_day.empty:
        ...
        st.plotly_chart(fig2,use_container_width=True, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
...
with colB:
    if not filtered_day.empty:
        ...
        st.plotly_chart(fig3,use_container_width=True, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
...
if not filtered_hour.empty:
    ...
    st.plotly_chart(fig4,use_container_width=True, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
...
if not filtered_hour.empty:
    ...
    st.plotly_chart(fig5,use_container_width=True, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
...
if not filtered_day.empty:
    ...
    st.plotly_chart(fig6,use_container_width=True, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False})
